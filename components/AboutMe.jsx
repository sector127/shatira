...
const AboutMe = () => {
  ...
  return (
    <div
      id="about"
      className={`text-white w-[300px] md:w-[672px] max-h-[500px] ${inconsolata.className} relative`}
    >
      <div className="bg-gray-900 rounded-sm shadow-2xl max-h-[500px] px-0 mx-auto border border-slate-700 hero__image">
